_base_ = [
    '../_base_/models/upernet_swin.py', '../_base_/datasets/cityscapes_to_bdd.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        pretrained="/data/ljh/pretrained/vssmsmall_dp03_ckpt_epoch_238.pth",        # copied from classification/configs/vssm/vssm_tiny_224.yaml
        dims=96,
        depths=(2, 2, 27, 2),
        ssm_d_state=16,
        ssm_dt_rank="auto",
