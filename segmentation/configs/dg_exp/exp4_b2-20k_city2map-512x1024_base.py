_base_ = [
    '../_base_/models/upernet_swin.py', '../_base_/datasets/cityscapes_to_mapillary.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        pretrained="/data/ljh/pretrained/vssmbase_dp05_ckpt_epoch_260.pth",        # copied from classification/configs/vssm/vssm_tiny_224.yaml
        dims=128,
        depths=(2, 2, 27, 2),
        ssm_d_state=16,
        ssm_dt_rank="auto",
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            # dict(type='MaskLoss', keep_ratio=0.5, loss_e_weight=1.0, loss_d_weight=1.0),
        ]
