...
# base
#bash ./tools/dist_test.sh configs/dg_exp/exp4_b2-20k_city2gtav-512x1024_base.py /data/ljh/segmentation/_LIKE_VMamba/output/city_to_bdd/exp4_b2-20k_city2bdd-512x1024_base_debug1/best_mIoU_iter_20000.pth 1
# w/ mask
